...
import { useClientMapping } from './useClientMapping'
...
export const ClientMapping = () => {
  ...
  const [values, handles] = useClientMapping()
    ...
    <div className='bg-[#f4f4f4] w-full flex flex-col p-15'>
      <div className='flex gap-10'>
        ...
        <ButtonCustom
          ...
          width={104}
          fontSize={14}
          onClick={() => router.push('/error-management/mapping/client/add')}
        >
          Add new
        </ButtonCustom>
      </div>
          ...
          <Grid container spacing={{ xs: 1, sm: 2, md: 3 }} className='pt-10'>
            ...
            <Grid item xs={12} sm={12} md={4} lg={4}>
              <CoreInput
                ...
                label={t('errorCodeClient')}
                placeholder={t('placeholder.errorCodeClient')}
                inputProps={{ maxLength: 255 }}
              />
            </Grid>
            <Grid item xs={12} sm={12} md={4} lg={4}>
