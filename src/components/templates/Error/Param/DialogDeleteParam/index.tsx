...
import { useDialogDeleteParam } from './useDialogDeleteParam'
import { DialogConfirmCustom } from '@/components/organism/DialogConfirmCustom'

export const DialogDeleteParam = ({
  id,
  refetch,
}: {
  id: number
  ...
  const [values, handles] = useDialogDeleteParam(id, refetch)
  ...
  return (
    <DialogConfirmCustom
      ...
      position='middle'
      width={410}
      formProps={{ onSubmit, 'aria-label': 'dialog delete param' }}
      onCancel={() => {
        hideDialog()
      }}
