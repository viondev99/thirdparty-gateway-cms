...
import { useManageTranslations } from './useManageTranslations'
...
export const ManageTranslations = () => {
  ...
  const [values, handles] = useManageTranslations()
  const { control, rowTranslations, columns, data, isLoading, t } = values
    ...
    <div className='bg-[#f4f4f4] w-full flex flex-col p-15'>
      <div className='flex gap-10'>
        ...
        <ButtonCustom
          ...
          fontSize={14}
          onClick={() =>
            router.push('/error-management/translations/add')
          }
        >
          Add new
        </ButtonCustom>
      ...
      <form onSubmit={onSubmit}>
        <div className='bg-[#ffffff] mt-15 h-104 rounded-xl p-15'>
          ...
          <div className='mt-12 text-center'>
            <ButtonCustom theme='submit' fontSize={14} width={120} height={42}>
              {t('common:search')}
            </ButtonCustom>
          </div>
        </div>
