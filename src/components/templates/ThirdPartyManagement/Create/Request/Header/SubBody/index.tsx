      ...
      <Grid container spacing={2} style={{display: 'flex', alignItems: 'center'}}>
        ...
        <Grid item xs={12} sm={12} md={6} lg={1.5}>
          <TextField
            ...
            error={(prods.submit || checkParamValue) && (isRequired('Param', paramValue).error || paramRegexSomeSpecialChar('Param', paramValue).error)}
            helperText={(prods.submit || checkParamValue) && (isRequired('Param', paramValue).message || paramRegexSomeSpecialChar('Param', paramValue).message)}
            required
