...
export const AddSubBody = (prods: Prods) => {
  ...
  prods.child.error = (isRequired('Feature', paramValue).error || 
  ...
  (isMaxLength('Format', format, 255).error))
      ...
      <Grid container spacing={2} style={{display: 'flex', alignItems: 'center'}}>
        ...
        <Grid item xs={12} sm={12} md={6} lg={1.5}>
          <TextField
            ...
            onBlur={() => setCheckDefaultValue(true)}
            error={
        ...
        <Grid item xs={12} sm={12} md={6} lg={1.5}>
          <TextField
            ...
            error={
              (prods.submit || checkFormat) &&
              (isMaxLength('Format', format, 255).error)
            }
            helperText={
              (prods.submit || checkFormat) &&
              (isMaxLength('Format', format, 255).message)
            }
