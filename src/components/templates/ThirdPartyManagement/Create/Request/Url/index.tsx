...
export const AddUrl = (prods: Prods): any => {
  ...
  const [featureAPIPropertiesId, setMappingCode] = React.useState<any>(prods.url.featureAPIPropertiesId)
  ...
  const [formatId, setFormat] = React.useState<any>(prods?.url?.formatId ?? 0)
