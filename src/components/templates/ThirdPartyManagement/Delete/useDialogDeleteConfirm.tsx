...
import { deleteThirdPartyApi } from '@/service/uaa/thirdParty/delete'
import {
  DeleteInput,
  DeleteInputSchema,
} from '@/service/uaa/thirdParty/delete/schema'
...
export const useDialogDeleteConfirm = (id: number, refetch: any) => {
  ...
  const { mutate, isLoading } = useMutation(deleteThirdPartyApi, {
    onSuccess: (data: any) => {
