...
import { paramRegexSomeSpecialChar } from '../../../Create/validate'
...
export const AddSubResponse = (prods: Prods): any => {
  ...
  const [featureAPIPropertiesId, setMappingCode] = React.useState<any>(
    prods?.featureAPIPropertiesId ?? 0
  )
  ...
  const shareSubResponseOfSub = (action: string, subParam: any) => {
          ...
          <List component='div' disablePadding>
            {(childs ?? []).map((child: any, i: number) => (
              <AddSubResponse
                ...
                shareSubResponse={shareSubResponseOfSub}
